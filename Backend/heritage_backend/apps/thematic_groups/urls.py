...
from .views import (
    ...
    GroupChatMessageGemView,
    GroupChatMessageListCreateView,
    GroupChatMuteView,
    GroupChatMessagePinView,
    GroupChatMessageReportView,
...
urlpatterns = [
    ...
    path("groups/<str:group_id>/chat/", GroupChatMessageListCreateView.as_view(), name="groups-chat"),
    path("groups/<str:group_id>/chat/mute/", GroupChatMuteView.as_view(), name="groups-chat-mute"),
    path("groups/<str:group_id>/chat/<str:message_id>/", GroupChatMessageDetailView.as_view(), name="groups-chat-message"),
    path("groups/<str:group_id>/chat/<str:message_id>/gem/", GroupChatMessageGemView.as_view(), name="groups-chat-message-gem"),
    path("groups/<str:group_id>/chat/<str:message_id>/pin/", GroupChatMessagePinView.as_view(), name="groups-chat-message-pin"),
    path("groups/<str:group_id>/chat/<str:message_id>/report/", GroupChatMessageReportView.as_view(), name="groups-chat-message-report"),
