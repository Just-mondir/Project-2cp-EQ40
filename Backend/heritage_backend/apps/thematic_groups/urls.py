...
from .views import (
    ...
    GroupJoinRequestEmailReviewView,
...
urlpatterns = [
    ...
    path("groups/<str:group_id>/requests/email-review/<str:token>/", GroupJoinRequestEmailReviewView.as_view(), name="groups-request-email-review"),
