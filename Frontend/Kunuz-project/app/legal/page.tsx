      ...
      <section className="max-w-4xl mx-auto px-6 py-14">
        ...
        <div className="space-y-1">
                <h2 className="text-xl font-black"style={{ color: "#BB9557" }}>
                  ...
                  <li className="list-disc pl-6 text-lg leading-loose"> Share accurate and respectful content </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Respect copyright laws </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Follow community guidelines</li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Not misuse the platform or attempt hacking </li> 
          ...
          <div className="space-y-1">
                <h2 className="text-xl font-black"style={{ color: "#BB9557" }}>
                  ...
                  <li className="list-disc pl-6 text-lg leading-loose"> Name or username </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Email address </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Uploaded content</li> 
                  ...
                  <li className="list-disc pl-6 text-lg leading-loose">Manage user accounts </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Improve the platform </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Ensure security</li> 
          ...
          <div className="space-y-1">
                <h2 className="text-xl font-black"style={{ color: "#BB9557" }}>
                  ...
                  <li className="list-disc pl-6 text-lg leading-loose"> Heritage photos </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Historical information </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Educational annotations</li> 
                  
                  <p className=" font-bold text-lg leading-relaxed">Prohibited Content</p>
                  <li className="list-disc pl-6 text-lg leading-loose">Offensive or political content </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Fake information </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Spam or advertisements</li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Copyrighted material without permission</li> 
          ...
          <div className="space-y-1">
                <h2 className="text-xl font-black"style={{ color: "#BB9557" }}>
                  ...
                  <li className="list-disc pl-6 text-lg leading-loose">  Books and articles used </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Historical websites </li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> Photographers and image owners</li> 
                  <li className="list-disc pl-6 text-lg leading-loose"> University supervisors </li> 
