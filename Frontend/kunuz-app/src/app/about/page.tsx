...
export default function About() {
  return (
    <main className="min-h-screen">
      <div className="px-4 py-12 sm:px-8 lg:px-32">
        <h1
          className="text-4xl sm:text-5xl lg:text-6xl font-bold mb-10 text-center"
        ...
        <div className="flex flex-col md:flex-row items-center gap-8 md:gap-12 mb-12 md:mb-16">
          ...
          <div className="md:basis-3/4 w-full">
            <p className="text-base sm:text-lg md:text-xl leading-relaxed" style={{ color: "#3b2314" }}>
        ...
        <div className="flex flex-col-reverse md:flex-row items-center gap-8 md:gap-12 mb-12 md:mb-16">
          <div className="md:basis-3/4 w-full">
            <p className="text-base sm:text-lg md:text-xl leading-relaxed" style={{ color: "#3b2314" }}>
