    ...
    <div className="flex h-[100dvh] overflow-hidden" style={{ backgroundColor: "#FFF8E2" }}>
      ...
      <div className="flex flex-col flex-1 overflow-y-auto ml-0 md:ml-[68px]">
        ...
        <div className="flex flex-col gap-7 px-4 md:px-16 pb-10">
          ...
          {/* How to Sign Up */}
          <div style={{ backgroundColor: "rgba(67, 40, 23, 0.10)", border: "2px solid #432817", borderRadius: "10px", padding: "18px 25px 25px 25px" }}>
            <p style={{ color: "#432817", fontFamily: "var(--font-lato), 'Lato', sans-serif", fontWeight: 400, fontSize: "20px", marginBottom: "11px" }}>
              how to Sign Up
            </p>
          ...
          {/* How to Login */}
          <div style={{ backgroundColor: "rgba(67, 40, 23, 0.10)", border: "2px solid #432817", borderRadius: "10px", padding: "19px 24px 25px 24px" }}>
            <p style={{ color: "#432817", fontFamily: "var(--font-lato), 'Lato', sans-serif", fontWeight: 400, fontSize: "20px", marginBottom: "10px" }}>
              how to Login
            </p>
            <ol style={{ color: "#000000", fontFamily: "var(--font-lato), sans-serif", fontWeight: 400, fontSize: "15px", lineHeight: "24px", paddingLeft: "20px", listStyleType: "decimal" }}>
              <li>If you already have an account, click on <strong>"Login"</strong>.</li>
            ...
            <div style={{ marginTop: "12px" }}>
              <p style={{ color: "#000000", fontFamily: "var(--font-lato), 'Lato', sans-serif", fontWeight: 700, fontSize: "15px", lineHeight: "24px" }}>
                Forgot Your Password?
              </p>
              <p style={{ color: "#000000", fontFamily: "var(--font-lato), 'Lato', sans-serif", fontWeight: 400, fontSize: "15px", lineHeight: "24px" }}>
            ...
            <p style={{ color: "#000000", fontFamily: "var(--font-lato), 'Lato', sans-serif", fontWeight: 400, fontSize: "15px", lineHeight: "24px", marginTop: "12px" }}>
