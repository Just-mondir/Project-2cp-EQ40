...
if (invitedUsers && invitedUsers.length > 0) {
  ...
  return (
    <div className="flex min-h-[100dvh] overflow-y-auto md:h-[100dvh] md:overflow-hidden" style={{ backgroundColor: "#F7F5EF" }}>
      ...
      <div className="flex flex-col flex-1 overflow-visible pb-20 md:ml-[68px] md:overflow-hidden md:pb-0">
        ...
        <div className="flex flex-1 flex-col overflow-visible px-4 pb-8 gap-5 sm:px-8 md:flex-row md:overflow-hidden md:gap-6">
          ...
          {/* ── Left panel ── */}
          <div className="w-full flex flex-col flex-shrink-0 overflow-visible md:w-[240px] md:overflow-hidden">
