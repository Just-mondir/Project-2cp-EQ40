...
export default function SetProfilePage() {
  ...
  // ← CHANGED: updates profileImage inside object
  ...
  // ← CHANGED: updates selectedExpertise inside object
  const handleExpertiseChange = (option: string) => {
    setFormData(prev => ({ ...prev, selectedExpertise: option }));
  };
          ...
          <div className="flex-1 flex items-center justify-center px-6 py-10 md:px-10 lg:px-14">
            <div className="w-full max-w-[420px] flex flex-col" style={{ gap: "20px" }}>
              ...
              <div className="flex justify-center">
                ...
                >
                  {/* ← CHANGED: using formData.profileImage */}
              ...
              <form onSubmit={handleSubmit} className="flex flex-col" style={{ gap: "13px" }}>
                ...
                <div className="flex flex-col" style={{ gap: "8px" }}>
                  <label
                    htmlFor="firstName"
                    style={{ color: "#432817", fontFamily: "var(--font-lato)", fontWeight: 400, fontSize: "17.85px" }}
                  >
                    First name
                  </label>
                  <input
                    ...
                    style={{ height: "47px", borderRadius: "10px", border: "0.74px solid #79747E", backgroundColor: "#F2F2F2", padding: "0 12px", fontSize: "16px" }}
                  />
                </div>
                ...
                <div className="flex flex-col" style={{ gap: "8px" }}>
                  ...
                  <textarea
                    ...
                    onChange={handleChange}
                    className="w-full outline-none focus:ring-2 focus:ring-[#432817] transition-all"
                    style={{ height: "61px", borderRadius: "10px", border: "0.74px solid #79747E", backgroundColor: "#F2F2F2", padding: "8px 12px", fontSize: "16px", resize: "none" }}
                  />
                </div>
                    ...
                    {expertiseOptions.map((option) => (
                      <button
                        ...
                        style={{
                          ...
                          fontFamily: "var(--font-lato)",
                          fontWeight: 400,
                          border: formData.selectedExpertise === option ? "none" : "0.84px solid #79747E",
                          backgroundColor: formData.selectedExpertise === option ? "#432817" : "transparent",
                          color: formData.selectedExpertise === option ? "#FFFFFF" : "#79747E",
                          cursor: "pointer",
                          transition: "all 0.2s",
                        }}
                      >
                ...
                <div className="flex justify-center" style={{ marginTop: "7px" }}>
                  <button
                    ...
                    style={{ display: "flex", alignItems: "center", gap: "10px", padding: "5px", borderRadius: "10px", border: "1px solid #79747E", backgroundColor: "#F1F1F1", cursor: "pointer" }}
                  >
                    <span style={{ color: "#432817", fontFamily: "var(--font-lato)", fontWeight: 400, fontSize: "17px", padding: "4px 8px", whiteSpace: "nowrap" }}>
                      Request Badge
                    </span>
                    <span style={{ width: "25px", height: "25px", borderRadius: "7px", backgroundColor: "#432817", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
                ...
                <button
                  ...
                  style={{ height: "47px", borderRadius: "10px", backgroundColor: "#432817", color: "#FFFFFF", fontFamily: "var(--font-lato)", fontWeight: 900, fontSize: "23.8px", border: "none", cursor: "pointer", marginTop: "4px" }}
                >
                  Done
                </button>
