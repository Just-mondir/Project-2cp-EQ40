...
export default function LeftSidebar({ activePage = "home", variant = "default" }) {
    ...
    const isAddPost = activePage === "add-post";
    const sidebarBg = isAddPost ? "#F7F5EF" : "#FFF8E2";
    const iconDefault = "#432817";          // brown for both variants
                    ...
                    return (
                        <div key={item.key} className="relative group">
                            <Link
                                ...
                                onMouseEnter={(e) => { if (!isActive) e.currentTarget.style.backgroundColor = iconHover; }}
                ...
                <div className="relative group">
                    ...
                    >
                        <svg width="20" height="20" viewBox="0 0 24 24" fill="none"
                            stroke={iconDefault} strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
