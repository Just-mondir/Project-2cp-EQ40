...
export default function Footer() {
  ...
  return (
    <footer style={{ backgroundColor: "#3b2314" }} className="text-[#e8d9c0] px-4 sm:px-6 md:px-12 py-8 md:py-10">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6 md:gap-8">
        ...
        <div className="flex flex-col gap-3 md:gap-4 sm:col-span-2 lg:col-span-2 -mt-0 sm:-mt-10">
          ...
          <div className="flex gap-3 md:gap-4 mt-2">
            {/* Social Icons with #FFF8E2 fill */}
            <div className="w-[18px] h-[18px] sm:w-[20px] sm:h-[20px]">
              <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" fill="#FFF8E2" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-4.714-6.231-5.401 6.231H2.746l7.73-8.835L1.254 2.25H8.08l4.253 5.622 5.911-5.622zm-1.161 17.52h1.833L7.084 4.126H5.117z" /></svg>
            </div>
            <div className="w-[18px] h-[18px] sm:w-[20px] sm:h-[20px]">
