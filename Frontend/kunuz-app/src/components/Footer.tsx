...
export default function Footer() {
 ...
 if (
  ...
  pathname === "/Help"||
  pathname === "/Help/Account-management"||
  pathname === "/Help/Creating-posts"||
  pathname === "/Help/Interaction-withe-posts"||
  pathname === "/Help/Monuments-in-danger"||
  pathname === "/Help/Reporting-content"||
  pathname === "/Help/Searche-by-filter"
) {
  return null;
}
